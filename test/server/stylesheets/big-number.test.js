			...
			.then(function (transformedXml) {
				transformedXml.should.equal(
					'<div class="n-content-big-number">' +
						'<span class="n-content-big-number__title">33m</span>' +
						'<span class="n-content-big-number__content">These are powerful but fragile emissaries of a culture that not even their descendants remember</span>' +
					'</div>\n'
				);
			});
	});
	...
	it('should maintain html', function () {
		return transform(
			...
			.then(function (transformedXml) {
				transformedXml.should.equal(
					'<div class="n-content-big-number">' +
						'<span class="n-content-big-number__title"><a href="http://next.ft.com/1b852d96-ced7-11e4-893d-00144feab7de">33m</a></span>' +
						'<span class="n-content-big-number__content">These are <a href="http://next.ft.com/712943a2-cda3-11e4-8760-00144feab7de">powerful but fragile</a> emissaries of a culture that not even their descendants remember</span>' +
					'</div>\n'
				);
			});
	});
